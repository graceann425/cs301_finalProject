...
class ASMParser{
 ...
 private:
  ...
  LabelTable labels; // stores labels found in the input file
  string encoded;  // stores the instruction after it's encoded to binary
  ...
  string encodeIType(Instruction &i, Opcode o);
  string encodeRType(Instruction &i, Opcode o);
  string encodeJType(Instruction &i, Opcode o);
